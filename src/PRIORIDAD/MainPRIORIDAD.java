 ...
 * @author rszaldumbide
 */
public class MainPRIORIDAD extends javax.swing.JFrame {
    ...
    public MainPRIORIDAD() {
        initComponents();
        m=new metodosPRIORIDAD(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ALGORITMO PRIORIDAD");
        ...
        tblProcesos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PROCESOS", "TIEMPO LLEGADA (L)", "TIEMPO EJECUCION (U)", "PRIORIDAD (P)"
            }
        ) {
        ...
        jLabel6.setText("RESULTADOS DEL PROCESO PRIORIDAD");
    ...
    private void llenadoRafaga1(){
        ...
        while(existeProceso==true){
            ...
            while(Valor>0) {
                ...
                if(Valor==0){
                    matrizVerificacion[filaCola][4] = "No listo";
                }
    ...
    private void matrices(){
        ...
        matrizVerificacion= new String[cantidad][5];
        matriztmp = new String[cantidad][5];
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            matriztmp[i][3]= tblProcesos.getValueAt(i, 3).toString();//prioridad
            matriztmp[i][4]= "Listo";//estado
        ...
        try{
            for(int i=0; i<matriztmp.length; i++) {
                if(matriztmp[i][1].equalsIgnoreCase(tiempoLlegada)){
                    ...
                    matrizVerificacion[contador][2] = matriztmp[i][3];
                    matrizVerificacion[contador][3] = String.valueOf(i);
                    matrizVerificacion[contador][4] = "Listo";
                    contador ++;
                }
            }
            recorrer();
    ...
    private void recorrer(){
        try{
            ...
            for(int i=0; i<contador; i++) {
                ...
                pMenor=Double.parseDouble(matrizVerificacion[i][2]);
                fila=Integer.parseInt(matrizVerificacion[i][3]);
                if(matrizVerificacion[i][4].equalsIgnoreCase("Listo")){
                    existeProceso = true;
                    filaCola=i;
                    break;
                }
            ...
            for(int i=0; i<contador; i++) {            
                if(Double.parseDouble(matrizVerificacion[i][2]) < pMenor && matrizVerificacion[i][4].equalsIgnoreCase("Listo")){
                    nMenor=matrizVerificacion[i][0];
                    uMenor=Double.parseDouble(matrizVerificacion[i][1]);
                    pMenor=Double.parseDouble(matrizVerificacion[i][2]);
                    fila=Integer.parseInt(matrizVerificacion[i][3]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainPRIORIDAD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainPRIORIDAD().setVisible(true);
            }
        });
    }
